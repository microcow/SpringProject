...
// taglib prefix="sec" uri="http://www.springframework.org/security/tags" : 이 JSP 페이지는 JSTL 코어 태그와 Spring Security 태그 라이브러리(sec:authorize)를 사용하기 위함
%>
<!DOCTYPE html>
<html>
<head>
        ...
        <div>
           ...
           <!-- sec:authorize 태그는 Spring Security의 spring-security-taglibs 라이브러리를 사용하여
            ...
            <sec:authorize access="isAuthenticated()"> <!-- isAuthenticated()는 현재 사용자가 인증된 상태인지를 검사하는 함수. 즉, 로그인 되었을 때 보임 -->
               ...
               <%// ${principal}은 Spring Security에서 현재 인증된 사용자(principal)의 정보를 가져오기 위한 표현식입니다. (상세 설명은 Spring Security를 사용하여 인증된 사용자의 정보를 JSP에서사용하는 방법 정리내용 참고)
